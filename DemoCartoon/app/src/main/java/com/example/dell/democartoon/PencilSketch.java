...
public class PencilSketch extends AppCompatActivity {

    private int currImage;

    protected void onCreate(Bundle savedInstanceState) {
        Button PencilSketch= (Button) findViewById(R.id.btnPencilSketch);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pencil_sketch);


    }
    private void setPencilSketchListener() {
         Button PencilSketch= (Button) findViewById(R.id.btnPencilSketch);
        PencilSketch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                setPencilSketchListener();
            }
        });
    }
    ...
    public class Sketch {
        ...
        public  final Bitmap changeToSketch(Bitmap bitmap) {
            return changeToSketch(bitmap, 5,110);
        }


        public  final Bitmap changeToSketch(Bitmap src, int type, int threshold) {
